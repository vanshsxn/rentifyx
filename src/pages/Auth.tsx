      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl p-8 card-shadow space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg border border-border bg-background text-sm font-medium text-foreground hover:bg-secondary transition-colors active:scale-[0.98]"
          >
